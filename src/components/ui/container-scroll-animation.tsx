...
export const ContainerScroll = ({
  ...
  const scaleDimensions = () => {
    return isMobile ? [0.7, 0.9] : [1.15, 1.05];
  };
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-6xl -mt-12 mx-auto h-[35rem] md:h-[50rem] w-full border-4 border-[#383838] p-2 md:p-6 bg-black rounded-[30px] shadow-2xl"
    >
